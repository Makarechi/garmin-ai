...
Apply replaces the transport update payload with an opaque digest/redaction receipt,
...
conversation retention policy and backups are outside this command. Old backup files
