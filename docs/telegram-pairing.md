...
After the migrated service starts, that value becomes an explicit `ChannelBinding`
to the installation's internal owner. It never becomes the owner's internal ID and
