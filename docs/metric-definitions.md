...
unit and dimension, optional ordinal scale, time semantics, bounds, coverage policy and allowed
aggregations. Active versions are immutable; a scale or unit change creates a new version.
